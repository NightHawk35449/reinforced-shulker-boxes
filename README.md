...
The Reinforced Shulker Boxes mod adds reinforced shulker boxes with progressively larger inventories.

This is an **unofficial port of Reinforced Shulker Boxes by Aton-Kish**, updated for newer versions of Minecraft.

This port currently targets **Minecraft 26.1.2** using Fabric.
...
Reinforced Core is required for Reinforced Shulker Boxes to function.

## Original Project & Credits

**Original mod:** Reinforced Shulker Boxes
**Original author:** Aton-Kish

This project is an unofficial port and is not affiliated with or endorsed by Aton-Kish.

**Original GitHub:**
https://github.com/Aton-Kish/reinforced-shulker-boxes
...
The original project is licensed under the MIT License. The original copyright and license information is preserved in this project.
