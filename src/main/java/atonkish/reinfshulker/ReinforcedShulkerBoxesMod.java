...
// CONFIRMED: unchanged structure vs. the 1.21.11 original -- cross-checked
// line-for-line against decompiled reinforced-barrels-2.7.6+26.1.2.jar's
// ReinforcedBarrelsMod (identical ModInitializer/ReinforcedCoreModInitializer
// shape, identical FabricLoader.getInstance().getEntrypoints(...) call, and
// identical net.minecraft.world.item.DyeColor import location). No vanilla
// renames needed in this file at all; it's pure glue into already-ported
// classes.
